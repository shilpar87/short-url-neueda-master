...
@Entity
public class ShortUrlStatistic implements Serializable {
	...
	public ShortUrlStatistic(String browser, String deviceType, String operatingSystem, ShortUrl url) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ShortUrlStatistic other = (ShortUrlStatistic) obj;
		if (id == null) {
			if (other.id != null)
				return false;
