...
public class StatisticService {
	...
	public ShortUrlStatistic create(ShortUrlStatistic statistic) {
	...
	public ShortUrlStatistic mapFrom(Map<String, String> headers, ShortUrl url) {
		...
		return new ShortUrlStatistic(browser, deviceType, operatingSystem, url);
	}
