...
import static com.shorturl.util.Constants.MAX_LONG_URL_SIZE;
...
public class ShortUrlDTO implements Serializable {
	...
	public ShortUrlDTO(String code, @NotNull @NotEmpty @URL @Length(max = 2048) String longUrl) {
		super();
		this.code = code;
	...
	public boolean equals(Object obj) {
		...
		ShortUrlDTO other = (ShortUrlDTO) obj;
		if (code == null) {
			if (other.code != null) {
				return false;
			}
