package com.shorturl.test.resources.exceptions;
...
import com.shorturl.exceptions.ResourceExceptionHandler;
import com.shorturl.exceptions.StandardError;
import com.shorturl.exceptions.ValidationError;
...
public class ResourceExceptionHandlerTest {
	...
	public void whenHandlingANotFoundExceptionReturnsStatusNotFoundAndExpectedMessage() {
		...
		ShortUrlNotFoundException e = new ShortUrlNotFoundException(message);
	...
	public void whenHandlingAMethodArgumentNotValidExceptionReturnsStatusBadRequestAndExpectedMessage() throws NoSuchMethodException, SecurityException {
		// Given
		Method method = ShortUrlDTO.class.getMethod("setLongUrl", String.class);
